...
export const tiers: PricingTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      `Upscale up to 8x`,
      `Create images up to 16000x16000px`,
...
export default function PricingPage() {
  ...
  return (
    <section
      id='pricing' 
      className={cn('flex flex-col w-full items-center bg-white', styles.fancyOverlay)}
    >
      <div className="w-full flex flex-col items-center mt-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col items-center">
          <div className="w-full lg:w-auto mx-auto max-w-4xl lg:text-center">
            <h1 className="text-black dark:text-white text-3xl font-semibold max-w-xs sm:max-w-none md:text-6xl !leading-tight">
              Pricing
            </h1>
              ...
              >
                ...
                >
                  ...
                  onClick={handleSignIn}
                    ...
                    className={cn(
                      'w-full inline-flex items-center justify-center font-medium ring-offset-background hover:opacity-80 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 text-black dark:text-white h-12 rounded-xl px-6 sm:px-10 text-md',
